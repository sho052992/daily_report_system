...
public class EmployeeService extends ServiceBase {
    ...
    public EmployeeView findOne(String code, String plainPass, String pepper) {
        ...
        try {
            ...
            //社員番号とハッシュ化済パスワードを条件に未削除の従業員を１件取得
    ...
    /**
     * 画面から入力された従業員の登録内容をもとにデータを１件作成、従業員テーブルに登録
    ...
    /**
     * 画面から入力された従業員の更新内容をもとにデータを１件作成し、従業員テーブルを更新
     * @param ev 画面から入力された従業員の登録内容
     * @param pepper pepper文字列
    ...
    /**
     * 社員番号とパスワードを条件に検索し、データを取得できるかどうかで認証結果を返却する
     * @param code 社員番号
